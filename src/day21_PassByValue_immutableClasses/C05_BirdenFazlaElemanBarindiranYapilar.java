...
public class C05_BirdenFazlaElemanBarindiranYapilar {
    ...
    public static void main(String[] args) {
        ...
        /*
         Java'da array ve arrayList gibi birden fazla element nbarindiran yapılarda
        java mthod'da yapilan degisikligin
    elementşere mi yoksa array/arrayList'in kendisine mi yapilacagına bakar.

            Elementler degisti ise Java bu degisikligi kabullenir. hata vermez
                AMMAA array ve arrayList'in kendisine atama yapilirsa
    bu degiisikligi kabul etmez,
        main method'da olan halini kullanir.
        ...
        // array'in elementlerini birer artırıp son halini yazdıran bir method olusturun
