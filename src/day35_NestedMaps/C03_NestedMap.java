...
public class C03_NestedMap {
    ...
    public static void main(String[] args) {
        ...
        //101 numarali ogrencının soyismini yazdırın
        System.out.println(ogrenciMap.get(101).get("isim")); // Ali

        //103 numarali ogrencının sinifini yazdırın
        System.out.println(ogrenciMap.get(103).get("sinif")); //11

        // 102 numarali ogrencının soyismini "kaya" yapın
        ogrenciMap.get(102).put("soyisim", "Kaya");

        // 101 numaralı ogrencının sınıfını 10 yapın
